            ...
            <div class="row g-0">
              ...
              <div class="col-lg-7">
                <div class="card-body p-4 p-sm-5">
                  ...
                  <h4 class="card-title" style="text-align: center; font-weight: bold; font-size: 30px;">CEDDO EDITION</h4>
                  <form action="/login" method="POST">
                    @csrf
                    <div class="login-separater text-center mb-4"> <span>CONNECTEZ-VOUS AVEC CEDDO</span>
                      <hr>
                    </div>
